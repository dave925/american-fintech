// American Fintech - Application JavaScript
...
const PRIMARY_ACCOUNT = Object.freeze({
    email: 'couzenshannah4@gmail.com',
    phone: '0544022365',
...
function buildPrimaryAccountTransactions() {
    ...
    const d = now.getDate();
    const day = (offset) => new Date(y, m, d + offset);

    return [
        { id: 1, name: 'Wire Transfer — Morgan Stanley', amount: 85000000.00, type: 'deposit', date: day(-3), category: 'Transfer', description: 'Incoming wire · Portfolio liquidation' },
        { id: 2, name: 'Real Estate Proceeds', amount: 42500000.00, type: 'deposit', date: day(-18), category: 'Real Estate', description: 'Escrow release · Property sale' },
        { id: 3, name: 'Couzens Holdings LLC', amount: 18750000.00, type: 'deposit', date: day(-32), category: 'Business', description: 'Quarterly profit distribution' },
        { id: 4, name: 'ACH — Investment Maturity', amount: 12000000.00, type: 'deposit', date: day(-45), category: 'Investment', description: 'Bond fund maturity proceeds' },
        { id: 5, name: 'Vanguard Dividend', amount: 2400000.00, type: 'deposit', date: day(-12), category: 'Investment', description: 'Quarterly dividend · Index fund' },
        { id: 6, name: 'Interest Payment', amount: 125000.00, type: 'deposit', date: day(-1), category: 'Interest', description: 'High-yield savings interest' },
        { id: 7, name: 'Direct Deposit — Payroll', amount: 45000.00, type: 'deposit', date: day(-7), category: 'Income', description: 'Biweekly salary deposit' },
        { id: 8, name: 'Direct Deposit — Payroll', amount: 45000.00, type: 'deposit', date: day(-21), category: 'Income', description: 'Biweekly salary deposit' },
        { id: 9, name: 'IRS Estimated Tax', amount: -2850000.00, type: 'payment', date: day(-14), category: 'Tax', description: 'Federal estimated tax payment' },
        { id: 10, name: 'Wire Transfer — Family Trust', amount: -5000000.00, type: 'payment', date: day(-25), category: 'Transfer', description: 'Outgoing wire · Trust funding' },
        { id: 11, name: 'Chase Mortgage', amount: -28450.00, type: 'payment', date: day(-2), category: 'Housing', description: 'Monthly mortgage payment' },
        { id: 12, name: 'American Express', amount: -12847.32, type: 'payment', date: day(-4), category: 'Credit Card', description: 'Statement balance payment' },
        { id: 13, name: 'Property Tax — County', amount: -18500.00, type: 'payment', date: day(-9), category: 'Housing', description: 'Semi-annual property tax' },
        { id: 14, name: 'Goldman Sachs Advisory', amount: -125000.00, type: 'payment', date: day(-11), category: 'Professional', description: 'Wealth management fee' },
        { id: 15, name: 'Four Seasons Hotels', amount: -3890.00, type: 'payment', date: day(-5), category: 'Travel', description: 'Hotel stay · New York' },
        { id: 16, name: 'Delta Air Lines', amount: -1245.80, type: 'payment', date: day(-6), category: 'Travel', description: 'Round-trip airfare' },
        { id: 17, name: 'Whole Foods Market', amount: -284.67, type: 'payment', date: day(-1), category: 'Groceries', description: 'Grocery purchase' },
        { id: 18, name: 'Amazon.com', amount: -156.42, type: 'payment', date: day(-2), category: 'Shopping', description: 'Online order' },
        { id: 19, name: 'Apple Store', amount: -2499.00, type: 'payment', date: day(-8), category: 'Shopping', description: 'MacBook Pro' },
        { id: 20, name: 'AT&T Wireless', amount: -189.00, type: 'payment', date: day(-10), category: 'Utilities', description: 'Monthly phone bill' },
        { id: 21, name: 'Netflix', amount: -15.99, type: 'payment', date: day(-3), category: 'Entertainment', description: 'Streaming subscription' },
        { id: 22, name: 'Uber', amount: -34.50, type: 'payment', date: day(-1), category: 'Transport', description: 'Ride share' },
        { id: 23, name: 'Shell Oil', amount: -68.25, type: 'payment', date: day(-2), category: 'Transport', description: 'Fuel purchase' },
        { id: 24, name: 'Starbucks', amount: -8.75, type: 'payment', date: day(0), category: 'Dining', description: 'Coffee purchase' },
        { id: 25, name: 'United Way Donation', amount: -50000.00, type: 'payment', date: day(-15), category: 'Charity', description: 'Charitable contribution' },
        { id: 26, name: 'Nordstrom', amount: -890.50, type: 'payment', date: day(-13), category: 'Shopping', description: 'Clothing purchase' },
        { id: 27, name: 'Tesla Supercharger', amount: -42.18, type: 'payment', date: day(-4), category: 'Transport', description: 'EV charging' },
        { id: 28, name: 'Spotify', amount: -10.99, type: 'payment', date: day(-5), category: 'Entertainment', description: 'Premium subscription' }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (currentUser.email) {
        ...
        if (currentPage === 'signup.html') {
            ...
            if (authSubtitle) authSubtitle.textContent = 'Add up to 4 additional accounts to your American Fintech profile';
        }
    }
});
...
function apexLogin() {
    ...
    try {
        ...
        showApexToast('Login successful! Welcome to American Fintech.', 'success');
        setTimeout(() => {
...
function contactWhatsApp() {
    ...
    const message = encodeURIComponent('Hello! I need help with my American Fintech account.');
